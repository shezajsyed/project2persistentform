...
def init_db():
    ...
    if c.fetchone()[0] == 0:
        movies = [
            ("La La Land", "ui/png/LLL_1.png"),
            ("How To Lose a Guy In 10 Days", "ui/png/HTLAGITD_4.png"),
            ("27 Dresses", "ui/png/TSD_2.png"),
            ("The Notebook", "ui/png/TN_3.png"),
            ("The Princess Bride", "ui/png/TPB_5.png")
        ]
...
class MainPage(tk.Tk):
    ...
    def __init__(self):
        ...
        self.bg_image = Image.open("ui/png/Hearts_B.png")
    ...
    def load_posters(self):
        ...
        base_path = os.path.dirname(os.path.abspath(__file__))  # folder where this script is

        for idx, (title, image) in enumerate(self.movies):
            full_path = os.path.join(base_path, image)  # full absolute path
            if not os.path.exists(full_path):
                print(f"Image not found: {full_path}")  # helps debug missing files
                continue

            img = Image.open(full_path).resize((180, 260))
